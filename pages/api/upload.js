...
export default function upload(req, res) {
  ...
  execFile('python3', [scriptPath, customFilePath,outputDir], (error, stdout, stderr) => {
    ...
    // Optionally, handle stdout or stderr if your Python script outputs useful information
    console.log('Python script output:', stdout);
  });
      
      res.status(200).json({ message: 'File uploaded successfully', path: customFilePath });
    });
